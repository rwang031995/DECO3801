...
function distanceApproxDevice(pointA, pointB){
    return distanceApprox(pointA.coords.longitude, pointA.coords.latitude, pointB.coords.longitude, pointB.coords.latitude);
}
